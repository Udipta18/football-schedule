    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="p-4 md:p-6 overflow-y-auto flex-1 custom-scrollbar">
                    {dayMatches.length === 0 ? (
                        <div className="text-center py-16">
                            ...
                            <p className="text-slate-400 text-xl font-medium">No matches scheduled</p>
                ...
                {/* Footer */}
                <div className="glass p-4 flex justify-center flex-shrink-0 border-t border-white/10">
                    <button
                        onClick={onClose}
